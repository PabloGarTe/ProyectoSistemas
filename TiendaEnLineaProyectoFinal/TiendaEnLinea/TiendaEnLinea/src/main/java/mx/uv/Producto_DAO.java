...
public class Producto_DAO {
    public boolean crearUsuario(Producto producto){
        ...
        try{
            ...
            String sql="INSERT INTO Producto values ('"+producto.getNombre()+"',"+producto.getPrecioProducto()+",'"+producto.getDescripcionProducto()+"','"+producto.getImagenProducto()+"')";
    ...
    public boolean eliminarUsuarios(String nombrePorducto){
        ...
        try{
            ...
            String sql="DELETE FROM Producto WHERE nombreProducto = '"+nombrePorducto + "'";
            System.out.println(sql);
            con = cc.conectarMySQL();
            stm = con.createStatement();
            stm.execute(sql);
