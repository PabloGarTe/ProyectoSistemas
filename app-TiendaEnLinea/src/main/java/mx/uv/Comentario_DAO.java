...
public class Comentario_DAO {
    public boolean crearComentario(Comentario comentario){
        ...
        try{
            ...
            String sql="INSERT INTO comentario values ('"+comentario.getCorreoCliente()+"','"+comentario.getNombreCliente()+"','"+comentario.getDescripcion()+"');";
    ...
    public List<Comentario> readAll() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                Comentario c = new Comentario(rs.getString(1),
